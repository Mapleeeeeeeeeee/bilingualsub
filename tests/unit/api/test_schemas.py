...
class TestJobCreateRequest:
    def test_valid_source_url(self) -> None:
        req = JobCreateRequest(source_url="https://www.youtube.com/watch?v=dQw4w9WgXcQ")
        assert str(req.source_url) == "https://www.youtube.com/watch?v=dQw4w9WgXcQ"

    def test_default_languages(self) -> None:
        req = JobCreateRequest(source_url="https://www.youtube.com/watch?v=test123")
    ...
    def test_invalid_url_rejected(self) -> None:
        with pytest.raises(ValidationError):
            JobCreateRequest(source_url="not-a-url")
